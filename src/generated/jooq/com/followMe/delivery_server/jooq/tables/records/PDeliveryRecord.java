...
public class PDeliveryRecord extends UpdatableRecordImpl<PDeliveryRecord> {
     ...
     */
    public PDeliveryRecord(UUID id, UUID orderId, OffsetDateTime createdAt, OffsetDateTime updatedAt, UUID createdBy, UUID updatedBy, OffsetDateTime deletedAt, UUID deletedBy, String deliveryAddress, UUID destinationHubId, String recipient, String recipientSlackId, UUID sourceHubId, UUID vendorDeliveryManagerId) {
        super(PDelivery.P_DELIVERY);
